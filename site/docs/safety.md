...
| Impression 3D    | Plastiques ABS et composites    | Brûlures[^1], Fumées[^3]             | Gants[^2], ouverture des fenêtres / masque à gaz[^4]    |
| CNC              | Bois                            | Projections[^5], poussière           | Ouverture des fenêtres / masque à gaz[^4], lunettes[^6] |
| CNC              | Métal                           | Projections[^5], copeaux             | Lunettes[^6]                                            |
| CNC              | Plastique et acrylique          | Projections[^5], Fumées[^3], copeaux | Ouverture des fenêtres / masque à gaz[^4], lunettes[^6] |
| Découpeuse laser | Tout type                       | Fumées[^3], Rayonnement laser[^7]    | Ouverture des fenêtres / masque à gaz[^4], lunettes[^8] |
| Outil à main     | Pistolet thermique              | Brûlures[^1], Projections[^5]        | Gants[^2], lunettes[^6]                                 |
| Outil à main     | Pistolet à colle                | Brûlures[^1]                         | Gants[^2]                                               |
| Outil à main     | Perceuse                        | Projections[^5], moteur rotatif[^9]  | Gants[^2], lunettes[^6]                                 |
| Outil à main     | Ponceuse                        | Brûlures[^1], Projections[^5]        | Gants[^2], masque à gaz[^4], lunettes[^6]               |
| Outil à main     | Fer à souder                    | Brûlures[^1], Projections[^5]        | Gants[^2], lunettes[^6]                                 |
...
| Lunettes UV                   | Lumière UV                 | ![lunettes](/assets/safety-7.png) |
| Gants résistants aux coupures | Coupures, scie, cutter     | ![gants](/assets/safety-3.png)    |
| Gants résistants à la chaleur | Haute température          | ![gants](/assets/safety-4.png)    |
| Casque                        | Bruits forts               | ![casque](/assets/safety-5.png)   |
